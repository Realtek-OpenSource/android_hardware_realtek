...
LOCAL_C_INCLUDES += hardware/realtek/realtek_omx/component/video_$(TARGET_BOARD_PLATFORM)/enc
...
#LOCAL_CLANG := true
LOCAL_C_INCLUDES += hardware/realtek/VideoEngine2/$(TARGET_BOARD_PLATFORM)/rtk_wrapper/third_party/libyuv/include
endif
