...
#define YUV_STATE_VERSION8      (0x72746b38) //rtk9
...
#define CODEC_ALIGN64(x)      CODEC_ALIGN(x, 64)
...
typedef struct {
    ...
    struct tch_metadata technicolor_data;
