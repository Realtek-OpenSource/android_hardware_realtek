...
#ifndef RTK_OMX_PLUGIN

#define RTK_OMX_PLUGIN

#include <media/hardware/OMXPluginBase.h>

namespace android {

struct RTKOMXPlugin : public OMXPluginBase {
    RTKOMXPlugin();
    virtual ~RTKOMXPlugin();
...
private:
    ...
    typedef OMX_ERRORTYPE (*SetupTunnel)(
    ...
    SetupTunnel mSetupTunnel;

    RTKOMXPlugin(const RTKOMXPlugin &);
    RTKOMXPlugin &operator=(const RTKOMXPlugin &);
};

}  // namespace android

#endif  // RTK_OMX_PLUGIN
